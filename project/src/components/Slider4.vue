<template>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="../assets/toy/dan/dan1.jpg" alt="...">
...
<script>
  export default {
    ...
    data () {
      return {
        data1: [
        {src: require('../assets/toy/dan/dan2.jpg'), name: 'Ô tô robot biến hình ', price: '450.000vnd', status: 'new'},
        {src: require('../assets/toy/dan/dan3.jpg'), name: 'Áo thun tay ngắn - T555', price: '160.000vnd', status: 'new'},
        {src: require('../assets/toy/dan/dan4.jpg'), name: 'Áo vải tay ngắn - T155', price: '110.000vnd', status: 'new'}
        ]
      }
    }
  }
