<template>
  ...
  <div id="carousel-6" class="carousel slide" data-ride="carousel" data-interval="false">
    <!-- Indicators -->
    ...
    <div class="item active">
      <router-link to="detail-product"><img src="../assets/sp-slider/sosinh2/sosinh1.jpg" alt="..."></router-link>
...
<script>
  export default {
    ...
    data () {
      return {
        data1: [
        {src: require('../assets/sp-slider/sosinh2/sosinh2.jpg'), name: 'Ô tô robot biến hình ', price: '450.000vnd', status: 'new'},
        {src: require('../assets/sp-slider/sosinh2/sosinh3.jpg'), name: 'Áo thun tay ngắn - T555', price: '160.000vnd', status: 'new'},
        {src: require('../assets/sp-slider/sosinh2/sosinh4.jpg'), name: 'Áo vải tay ngắn - T155', price: '110.000vnd', status: 'new'}
        ]
      }
    }
  }
