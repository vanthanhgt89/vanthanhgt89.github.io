<template>
  <div class="container-item">
   <div id="carousel-11" class="carousel slide" data-ride="carousel" data-interval="false">
    <!-- Indicators -->
    ...
    <div class="item active">
      <router-link to="detail-product"><img src="../assets/sp-slider/g-bo1/aothun1.jpg" alt="..."></router-link>
...
<script>
  export default {
    ...
    data () {
      return {
        data1: [
        {src: require('../assets/sp-slider/g-bo1/aothun2.jpg'), name: 'Ô tô robot biến hình ', price: '450.000vnd', status: 'new'},
        {src: require('../assets/sp-slider/g-bo1/aothun3.jpg'), name: 'Áo thun tay ngắn - T555', price: '160.000vnd', status: 'new'}, {src: require('../assets/sp-slider/g-bo1/aothun4.jpg'), name: 'Áo thun tay ngắn - T555', price: '160.000vnd', status: 'new'}
        ]
      }
    }
  }
