<template>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <router-link to="detail-product"><img src="../assets/sp-slider/sosinh1/sosinh.jpg" alt="..."></router-link>
...
<script>
  export default {
    ...
    data () {
      return {
        data1: [
        {src: require('../assets/sp-slider/sosinh1/sosinh.jpg'), name: 'Ô tô robot biến hình ', price: '450.000vnd', status: 'new'},
        {src: require('../assets/sp-slider/sosinh1/sosinh2.jpg'), name: 'Áo thun tay ngắn - T555', price: '160.000vnd', status: 'new'},
        {src: require('../assets/sp-slider/sosinh1/sosinh3.jpg'), name: 'Áo vải tay ngắn - T155', price: '110.000vnd', status: 'new'}
        ]
      }
    }
  }
