<template>
  <div class="container-item">
   <div id="carousel-8" class="carousel slide" data-ride="carousel" data-interval="false">
    <!-- Indicators -->
...
<script>
  export default {
    ...
    data () {
      return {
        data1: [
        {src: require('../assets/sp-slider/b-bo1/aothun1.jpg'), name: 'Ô tô robot biến hình ', price: '450.000vnd', status: 'new'},
        {src: require('../assets/sp-slider/b-bo1/aothun2.jpg'), name: 'Áo thun tay ngắn - T555', price: '160.000vnd', status: 'new'},
        {src: require('../assets/sp-slider/b-bo1/aothun3.jpg'), name: 'Áo vải tay ngắn - T155', price: '110.000vnd', status: 'new'}, {src: require('../assets/sp-slider/sosinh3/sosinh5.jpg'), name: 'Áo vải tay ngắn - T155', price: '110.000vnd', status: 'new'}
        ]
      }
    }
  }
